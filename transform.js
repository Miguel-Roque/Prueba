function transformBinario() {
    ...
    const ires = document.querySelector(".respuesta__listo");
    const open = document.querySelector(".respuesta");
    open.classList.add("respuestao-pen");
    let codigob = inputbinary.value;
    if (codigob.length > 8 || codigob.length < 8) {
        ires.innerHTML = "Este no es un codigo binario IP valido (00000000-11111111)";
...
function transformDecimal(){
    ...
    if (codigob <= 255 && codigob >= 0) {
        ...
        ires.innerHTML = finaleRes;
    } else {
        ires.innerHTML = "Este no es un codigo decimal IP valido (0-255)";
    }
}
...
function transformHexadecimal(){
    ...
    ires.innerHTML = resultado;
    }else if (codigob.length == null) {
        eres.innerHTML = "Completa el campo";
    }else{
        eres.innerHTML = "Este no es un codigo hexadecimal IP valido (0-FF)";
    }
}
...
function serrar() {
    const salir = document.querySelector(".respuesta");
    salir.classList.remove("respuestao-pen");
}